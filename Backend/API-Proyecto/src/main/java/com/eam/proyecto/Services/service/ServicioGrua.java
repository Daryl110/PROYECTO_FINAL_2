 ...
 */
@Path("Grua")
public class ServicioGrua extends EstructuraRestFul<Grua> {
    ...
    public void create(Grua entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Grua entity) {
        super.edit(entity);
    }
