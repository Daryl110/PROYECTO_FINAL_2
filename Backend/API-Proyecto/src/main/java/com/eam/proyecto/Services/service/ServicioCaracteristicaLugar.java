...
public class ServicioCaracteristicaLugar extends EstructuraRestFul<CaracteristicaLugar> {
    ...
    public void create(CaracteristicaLugar entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, CaracteristicaLugar entity) {
        super.edit(entity);
    }
    ...
    @Override
    @Produces({MediaType.APPLICATION_JSON})
    public List<CaracteristicaLugar> findAll() {
