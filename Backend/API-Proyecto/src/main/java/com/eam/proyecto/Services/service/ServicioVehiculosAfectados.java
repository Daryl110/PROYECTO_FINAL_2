...
public class ServicioVehiculosAfectados extends EstructuraRestFul<VehiculosAfectados> {
    ...
    public void create(VehiculosAfectados entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, VehiculosAfectados entity) {
        super.edit(entity);
    }
    ...
    @Override
    @Produces({MediaType.APPLICATION_JSON})
    public List<VehiculosAfectados> findAll() {
