...
public class ServicioVehiculoTramite extends EstructuraRestFul<VehiculoTramite> {
    ...
    public void create(VehiculoTramite entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, VehiculoTramite entity) {
        super.edit(entity);
    }
